...
function AKS_runValidationSuiteV11() {
  return AKS_runNamedTestSuite_("AKS Platform V1.1", [
    ...
    { name: "ADMIN-006 / contrat protocole privé", test: AKS_testAdmin006PrivateProtocol_exposesClosedContract_ },
    { name: "ADMIN-006 / canonicalisation déterministe", test: AKS_testAdmin006PrivateProtocol_canonicalizesDeterministically_ },
    { name: "ADMIN-006 / valeurs canoniques interdites", test: AKS_testAdmin006PrivateProtocol_rejectsUnsafeCanonicalValues_ },
    { name: "ADMIN-006 / normalisation acteur et payload", test: AKS_testAdmin006PrivateProtocol_normalizesActorAndPayload_ },
    { name: "ADMIN-006 / catalogue payload fermé", test: AKS_testAdmin006PrivateProtocol_rejectsUnknownPayloadFields_ },
    { name: "ADMIN-006 / requête signée immuable", test: AKS_testAdmin006PrivateProtocol_createsImmutableSignedRequest_ },
    { name: "ADMIN-006 / validation requête nominale", test: AKS_testAdmin006PrivateProtocol_validatesSignedRequest_ },
    { name: "ADMIN-006 / payload altéré", test: AKS_testAdmin006PrivateProtocol_rejectsPayloadTampering_ },
    { name: "ADMIN-006 / signature altérée", test: AKS_testAdmin006PrivateProtocol_rejectsSignatureTampering_ },
    { name: "ADMIN-006 / environnement erroné", test: AKS_testAdmin006PrivateProtocol_rejectsWrongEnvironment_ },
    { name: "ADMIN-006 / requête expirée", test: AKS_testAdmin006PrivateProtocol_rejectsExpiredRequest_ },
    { name: "ADMIN-006 / rejeu refusé", test: AKS_testAdmin006PrivateProtocol_rejectsReplay_ },
    { name: "ADMIN-006 / garde anti-rejeu obligatoire", test: AKS_testAdmin006PrivateProtocol_requiresReplayGuard_ },
    { name: "ADMIN-006 / comparaison de signature", test: AKS_testAdmin006PrivateProtocol_usesConstantWorkComparison_ },
    { name: "ADMIN-006 / vecteurs SHA-256 et HMAC", test: AKS_testAdmin006PrivateProtocol_matchesCryptoVectors_ },
    { name: "ADMIN-006 / réponse signée nominale", test: AKS_testAdmin006PrivateProtocol_signsAndValidatesResponse_ },
    { name: "ADMIN-006 / réponse altérée", test: AKS_testAdmin006PrivateProtocol_rejectsAlteredResponse_ },
    { name: "ADMIN-006 / réponse non corrélée", test: AKS_testAdmin006PrivateProtocol_rejectsUncorrelatedResponse_ },
    { name: "ADMIN-006-B / backend inactif par défaut", test: AKS_testAdmin006LotB_backendIsInactiveByDefault_ },
    { name: "ADMIN-006-B / requête valide traitée", test: AKS_testAdmin006LotB_processesValidSignedRequest_ },
    { name: "ADMIN-006-B / signature invalide avant LOG", test: AKS_testAdmin006LotB_rejectsInvalidSignatureBeforeLog_ },
    { name: "ADMIN-006-B / configuration hors RECETTE", test: AKS_testAdmin006LotB_rejectsNonRecipeConfiguration_ },
    { name: "ADMIN-006-B / rotation secret précédent", test: AKS_testAdmin006LotB_acceptsPreviousSecretDuringRotation_ },
    { name: "ADMIN-006-B / événements LOG minimisés", test: AKS_testAdmin006LotB_minimizesLogEvents_ },
    { name: "ADMIN-006-B / preuve technique minimale", test: AKS_testAdmin006LotB_writesMinimalProof_ },
    { name: "ADMIN-006-B / corps invalide avant LOG", test: AKS_testAdmin006LotB_refusesMalformedBodyBeforeLog_ },
    { name: "ADMIN-006-B / première consommation anti-rejeu", test: AKS_testAdmin006LotB_replayGuardConsumesFirstRequest_ },
    { name: "ADMIN-006-B / rejeu requestId refusé", test: AKS_testAdmin006LotB_replayGuardRejectsRequestReplay_ },
    { name: "ADMIN-006-B / rejeu nonce refusé", test: AKS_testAdmin006LotB_replayGuardRejectsNonceReplay_ },
    { name: "ADMIN-006-B / purge anti-rejeu expirée", test: AKS_testAdmin006LotB_replayGuardPurgesExpiredRecords_ },
    { name: "ADMIN-006-B / verrou anti-rejeu indisponible", test: AKS_testAdmin006LotB_replayGuardRejectsUnavailableLock_ },
    { name: "ADMIN-006-B / persistance anti-rejeu relue", test: AKS_testAdmin006LotB_replayGuardVerifiesPersistence_ },
    { name: "ADMIN-006-B / second traitement refusé", test: AKS_testAdmin006LotB_backendRejectsSecondProcessing_ },
    { name: "ADMIN-006-B / activation Apps Script explicite", test: AKS_testAdmin006LotB_appsScriptGuardRequiresExplicitEnablement_ },
    { name: "ADMIN-006-B / adaptateurs non raccordés", test: AKS_testAdmin006LotB_adaptersRequireExplicitConnections_ },
    { name: "ADMIN-006-B / fabriques gelées sans endpoint", test: AKS_testAdmin006LotB_exportsFrozenFactoriesWithoutEndpoint_ },

    { name: "ADMIN-006-D3A / inactif sans configuration", test: AKS_testAdmin006D3A_runtimeIsClosedWhenDisabled_ },
    { name: "ADMIN-006-D3A / configuration exacte", test: AKS_testAdmin006D3A_readsExactNonSecretConfiguration_ },
    { name: "ADMIN-006-D3A / propriété privée inconnue", test: AKS_testAdmin006D3A_rejectsUnknownPrivateProperty_ },
    { name: "ADMIN-006-D3A / bornes anti-rejeu", test: AKS_testAdmin006D3A_rejectsInvalidBounds_ },
    { name: "ADMIN-006-D3A / lecture LOG et preuve dédiées", test: AKS_testAdmin006D3A_processesDedicatedLogAndProof_ },
    { name: "ADMIN-006-D3A / filtre de sévérité", test: AKS_testAdmin006D3A_filtersSeverity_ },
    { name: "ADMIN-006-D3A / environnement LOG croisé", test: AKS_testAdmin006D3A_rejectsCrossEnvironmentLog_ },
    { name: "ADMIN-006-D3A / dérive du schéma LOG", test: AKS_testAdmin006D3A_rejectsLogSchemaDrift_ },
    { name: "ADMIN-006-D3A / relecture de la preuve", test: AKS_testAdmin006D3A_requiresProofReadback_ },
    { name: "ADMIN-006-D3A / verrou de preuve indisponible", test: AKS_testAdmin006D3A_rejectsUnavailableProofLock_ },
    { name: "ADMIN-006-D3A / erreur HTTP générique", test: AKS_testAdmin006D3A_endpointReturnsGenericFailure_ },
    { name: "ADMIN-006-D3A / corps HTTP obligatoire", test: AKS_testAdmin006D3A_endpointRejectsMissingBody_ },
    { name: "ADMIN-006-D3A / fabrique runtime gelée", test: AKS_testAdmin006D3A_exportsFrozenRuntimeFactory_ },

    { name: "ADMIN-006-C / client inactif par défaut", test: AKS_testAdmin006LotC_clientIsInactiveByDefault_ },
    { name: "ADMIN-006-C / LOG_READ avant configuration", test: AKS_testAdmin006LotC_checksLogReadBeforeConfiguration_ },
    { name: "ADMIN-006-C / identité serveur obligatoire", test: AKS_testAdmin006LotC_requiresServerIdentityBeforeTransport_ },
    { name: "ADMIN-006-C / configuration inactive sans transport", test: AKS_testAdmin006LotC_disabledConfigurationDoesNotCallTransport_ },
    { name: "ADMIN-006-C / panne configuration isolée", test: AKS_testAdmin006LotC_configurationFailureIsIsolated_ },
    { name: "ADMIN-006-C / échange signé nominal", test: AKS_testAdmin006LotC_createsAndValidatesSignedExchange_ },
    { name: "ADMIN-006-C / réponse vide fermée", test: AKS_testAdmin006LotC_emptyResponseHasClosedState_ },
    { name: "ADMIN-006-C / réponse altérée isolée", test: AKS_testAdmin006LotC_alteredResponseIsUnavailable_ },
    { name: "ADMIN-006-C / panne transport isolée", test: AKS_testAdmin006LotC_transportFailureIsUnavailable_ },
    { name: "ADMIN-006-C / erreur backend isolée", test: AKS_testAdmin006LotC_backendErrorIsUnavailable_ },
    { name: "ADMIN-006-C / réessai avec identifiants neufs", test: AKS_testAdmin006LotC_retryUsesFreshIdentifiers_ },
    { name: "ADMIN-006-C / adaptateurs inactifs", test: AKS_testAdmin006LotC_inertAdaptersNeverExposeTransport_ },
    { name: "ADMIN-006-C / modèle dégradé isolé", test: AKS_testAdmin006LotC_dashboardModelPreservesDegradedState_ },
    { name: "ADMIN-006-C / aucun dépôt LOG bloquant", test: AKS_testAdmin006LotC_dashboardSourceContainsNoBlockingLogRepository_ },
    { name: "ADMIN-006-C / interface de réessai", test: AKS_testAdmin006LotC_dashboardTemplateExposesRetryState_ },
